...
```bash
cd /Users/mbjorke/Workspace/Lab/blueberry
npm run mcp:build
```
...
```bash
pwd
# Output: /Users/mbjorke/Workspace/Lab/blueberry
```
...
cp -r /Users/mbjorke/Workspace/Lab/blueberry/mcp-server ./
cp -r /Users/mbjorke/Workspace/Lab/blueberry/mcp-knowledge-base ./
...
ls /Users/mbjorke/Workspace/Lab/blueberry/mcp-server/dist/index.js
